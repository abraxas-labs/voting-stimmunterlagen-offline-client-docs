# Documentation Repository of VOTING Stimmunterlagen Offline
...
|---|---|---|
|User Manual| User manual for the end-user. | [Document](./technical-documentations/VOTING_Stimmunterlagen_Offline_User_Manual.pdf)|
|Building Block View| System view of the VOTING Stimmunterlagen Offline. | [Document](./technical-documentations/VOTING_Stimmunterlagen_Offline_Building_Block_View.pdf)|
|Runtime View| User and process level process definitions for the generation of E-Voting voting cards. | [Document](./technical-documentations/VOTING_Stimmunterlagen_Offline_Runtime_View.pdf)|
|Cryptography| Security concept for securing E-Voting voting cards including cryptographic specifications. | [Document](./technical-documentations/VOTING_Stimmunterlagen_Offline_Cryptography.pdf)|
|Trusted Build| Description of release process requirements and implementations to meet trusted builds. | [Document](./technical-documentations/VOTING_Stimmunterlagen_Offline_Trusted_Build.pdf)|
